...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, nickname=None, title=None, company=None,
                 address=None, homephone=None, mobilephone=None, workphone=None, fax=None, email=None, birth=None,
                 secondaryaddress=None, secondaryphone=None, id=None, all_phones_from_home_page=None):
